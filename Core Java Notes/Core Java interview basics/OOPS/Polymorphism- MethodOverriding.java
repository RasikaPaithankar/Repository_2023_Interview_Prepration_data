...
//	   otherwise it will throw an error "Exception Exception is not compatible with throws clause in Parent.method9()"
...
//	  if A class method return type is Parent then B class which extends class A, method return type can be 
//	  Child.
// 	  Here, Parent- method2 return NewParent but Child - method2 returns NewClass 
...
// 	  throwing an error - "Exception Exception is not compatible with throws clause in Parent.method9()"
